           ...
           <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="row">
                        <img src="Assets/Images/who1.png" width="200" height="200" class="img-circle" style="float:left"/>
                         <h4>&nbsp;&nbsp;&nbsp;  Who We Are?</h4>
                        <p id="what"> &nbsp;&nbsp; We are smart, passionate Programmer, Web Developer and Web Designer currently located in Canada and 
                            as a developer we create something more and more better for User to use in their daily life. So, this time, we come up with the idea to make a Game Tracker for enthusiastic Gamers!!! </p>
                        ...
                        <p id="who"> GameTracker is a place for you to keep track of your games. 
                            Once you register for an account, you can start adding games from our database and it will display the teams playing according to game selected.
                             ...
                             if you need to. Check out some of the tracked games without being a registered user at the HOME PAGE. </p>
                </div>
    </div>
